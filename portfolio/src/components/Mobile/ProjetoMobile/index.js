import styles from "@/components/Mobile/ProjetoMobile/styles.module.css"
...
export const ProjetoMobile = () => {
    return (
        <section className={styles.sectionProjects} id="projetos">
            <div>
                <h2>Projetos</h2>
                <div>
                    <Swiper modules={[Navigation, Pagination, Scrollbar, A11y]} slidesPerView={1} navigation  loop={true}>
