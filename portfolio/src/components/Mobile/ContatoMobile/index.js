import styles from "@/components/Mobile/ContatoMobile/styles.module.css"

export const ContatoMobile = () => {
    return (
            ...
            <div>
                ...
                <div className={styles.divInputs}>
                    ...
                    <div className={styles.divDir}>
                        ...
                        <textarea name="" id="" rows={7} cols={20} placeholder='Digite a mensagem'/>
                    </div>
                </div>
